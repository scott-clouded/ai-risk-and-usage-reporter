          ...
          <div className="dashboard-content animate-fade-in">
            ...
            {activeTab === 'users' && (
              <div className="users-tab-view panel animate-fade-in">
                <div className="panel-header-simple">
                  <h4>User Interaction Directory</h4>
                  <p>Browse active directory users, their department, total logins, and every application they have authenticated with.</p>
                </div>
            ...
            {activeTab === 'all' && (
              <div className="all-apps-tab panel animate-fade-in">
                <div className="panel-header-simple">
                  <h4>All Registered Applications Scanned</h4>
                  <p>Audit of all application integrations in the directory to identify unused services and potential security threats.</p>
                </div>
